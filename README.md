...
Личный мобильный AI-тренер по теннису: готовит бриф перед матчем, даёт короткие советы на переходах и помогает перестроиться между сетами. Показатели восстановления берутся из существующей таблицы `Oura-v2.health_logs`, а матчи и советы сохраняются в Supabase.
